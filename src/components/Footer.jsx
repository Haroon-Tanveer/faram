    ...
    <footer className="bg-green-100 text-gray-800 pt-12 pb-6 px-5 lg:px-14">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="#Vegetables" className="hover:text-green-600">
                Vegetables
              </a>
            </li>
            <li>
              <a href="#Fruits" className="hover:text-green-600">
                Fruits
              </a>
            </li>
            <li>
              <a href="#Dairy Products" className="hover:text-green-600">
                Dairy Products
              </a>
            </li>
            <li>
              <a href="#Beverages" className="hover:text-green-600">
                Beverages
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <p id="Contact" className="text-sm text-gray-600 mb-4">Phone: +92 333 6666 878</p>
      ...
      <div className="text-center text-sm text-gray-500 border-t pt-4">
        @copyright Developed By Haroon | All rights reserved
      </div>
    </footer>
  );
};
